...
interface OffersSectionProps {
  isDark: boolean;
  onOpenChat: (message?: string | any) => void;
}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                   onClick={(e) => {
                     ...
                     if (onOpenChat) {
                       onOpenChat(generalMessage);
                     } else {
                       alert('Chat opened with message: ' + generalMessage);
                     }
                   }}
                  ...
                  <button
                    type="button"
                     onClick={(e) => {
                       ...
                       if (onOpenChat) {
                         onOpenChat(offerData);
                       } else {
                         alert(`Chat opened with offer: ${offer.title}\nCoupon Code: ${couponCode}`);
                       }
                     }}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
               <Button
                 onClick={(e) => {
                   ...
                   if (onOpenChat) {
                     onOpenChat(guaranteeMessage);
                   } else {
                     alert('Chat opened with message: ' + guaranteeMessage);
                   }
                 }}
                size="lg"
